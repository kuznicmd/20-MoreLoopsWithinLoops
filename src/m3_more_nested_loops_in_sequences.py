...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 54
    answer = largest_number(([1, -4, 5, 13, 0], [54], [7, 0, 1, 4]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -1
    answer = largest_negative_number(([], [0, 1, 2, 3, 4], [4, 52, 7, -2, 1], [-12, 0, 4, 5, -1]))
    print('Expected and actual are:', expected, answer)
    ...
    # Test 3:
    expected = None
    answer = largest_negative_number(([1, 4, 12, 32], [], [7, 0, 1, 4], [], [42]))
    print('Expected and actual are:', expected, answer)

    # Test 4:
    expected = -4
    answer = largest_negative_number(([1, -4, 5, 13, 0], [54], [7, 0, 1, 4], [12, 0, 0, 0, 13]))
    print('Expected and actual are:', expected, answer)
